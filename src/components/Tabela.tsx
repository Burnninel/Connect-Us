        ...
        <>
            <div className={`flex flex-row items-center`}>
                ...
                <div className={`flex flex-row-reverse w-full`}>
                    <button className={`w-36 h-10 shadow-sm rounded mr-2 text-xs transition delay-90 hover:scale-110 duration-100 font-semibold text-sky-600`} onClick={handleShow}>
                        Adicionar Mapeador
                    </button>
            ...
            <table className="w-full rounded overflow-hidden mt-6 shadow-sm shadow-gray-50">
